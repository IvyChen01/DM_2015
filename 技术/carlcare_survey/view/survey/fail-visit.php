...
<body class="page fail-visit-page">
<div class="header">
    <div class="container">
        <a href="/">
    ...
    <div class="container">
        ...
        <div class="bk-dts">
            <div class="bk-sts">
                ...
                <a href="javascript:;" class="dt-sts active"> Not Accessible
                    <i class="b-l"></i>
                    <i class="b-2"></i>
                ...
                <div class="bk-mt">
                    <table>
                        ...
                        <tr>
                            ...
                            <th style="width: 23%"><span>FEEDBACK</span></th>
                            <th style="width: 23%"><span>STATUS</span></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                            ...
                            <td><span class="dt-vst">NO</span></td>
                        </tr>
                        <tr>
                            <td><span class="cus-number">LF1252616</span></td>
                            <td><span class="cus-name">ABBAS EFE</span></td>
