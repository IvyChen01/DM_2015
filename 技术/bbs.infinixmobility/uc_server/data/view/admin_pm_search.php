...
<div class="container">
	<div class="hastabmenu" style="height: 200px;">
		<ul class="tabmenu">
			<li class="tabcurrent"><a href="javascript:;" class="tabcurrent">Search messages</a></li>
			<li><a href="admin.php?m=pm&a=clear">Clear messages</a></li>
		</ul>
		<div id="searchpmdiv" class="tabcontentcur">
			<form action="admin.php?m=pm&a=ls" method="post">
				...
				<table class="dbtb">
					...
					<tr>
						<th class="tbtitle">Select sub-tables:</th>
						<td>
							<select name="srchtablename">
							 ...
							 Total Messages: <?php echo $pmnum;?>
						</td>
					</tr>
					<tr>
						<th></th>
						<td><input type="submit" value="Submit" class="btn" name="searchpmsubmit" /></td>
					</tr>
				</table>
			</form>
		</div>
	...
	<div class="mainbox">
		<?php if($pmlist) { ?>
			<form action="admin.php?m=pm&a=delete" onsubmit="return confirm('This action can not be restored, are you sure you want to delete these messages?');" method="post">
			<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>">
			...
			<table class="datalist fixwidth" onmouseover="addMouseEvent(this);">
				<tr>
					<th width="60"><input type="checkbox" name="chkall" id="chkall" onclick="checkall('deletepmid[]')" class="checkbox" /><label for="chkall">Delete</label></th>
