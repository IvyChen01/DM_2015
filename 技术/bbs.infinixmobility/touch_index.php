...
require './source/class/class_core.php';//寮曞叆绯荤粺鏍稿績鏂囦欢
$discuz = & discuz_core::instance();//浠ヤ笅浠ｇ爜涓哄垱寤哄強鍒濆鍖栧璞�
$discuz->init();
...
<!--Mark	<a href="forum.php?mod=forumdisplay&fid=38&filter=lastpost&orderby=lastpost&mobile=2">HOT</a> -->
	<a href="forum.php?mod=forumdisplay&fid=41&filter=lastpost&orderby=lastpost&mobile=2">Forum</a>
</div>
...
<div id="float-news" class="float-news" style="height:636px;">
    <div class="nv_c cl">
        ...
        <div class="umenu">
            ...
            <ul>
                <li class="li0 cl"><span></span><a href="touch_index.php?mobile=2">Home</a></li>
