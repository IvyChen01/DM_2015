...
$modules = array('extends', 'buyattachment', 'buythread', 'checkpost', 'connect',
	...
	'login', 'myfavforum', 'myfavthread', 'mypm', 'mythread','checkusername_email',
	'newthread', 'profile', 'publicpm', 'register', 'seccode','adpic','login_profile',
	'secure', 'sendpm', 'sendreply', 'sub_checkpost', 'sublist','hotsearch','shop','trade','tradepay',
	'toplist', 'viewthread', 'uploadavatar', 'pollvote', 'mynotelist','delmynotelist','nationlist','delfavthread','changeusername','changeemail',
	'modcp', 'topicadmin', 'forumimage', 'newthreads', 'signin', 'smiley', 'threadrecommend', 'check','changeprofile',
	'wsqindex', 'wsqsiteinfo', 'recommend','report','searchthread','sendrate','myreplythread','loginbyouter','delmypm',
	'wechat', 'wechat_clearlogin', 'checkinfo', 'seccodehtml','logout','forgetpwd','typeid','userslevel','threadlist','ad','registerbyphone','verificationcode','dsu_sign','changepwd');
