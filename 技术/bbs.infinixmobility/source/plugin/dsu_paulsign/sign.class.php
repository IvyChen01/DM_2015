	...
	function viewthread_sidetop_output() {
		...
		foreach($postlist as $key => $val) {
			if($days[$postlist[$key][authorid]][days]) {
				...
				if($open == '2')$echoonce = '<div class="qdsmile"><li><center>'.lang('plugin/dsu_paulsign','ta_mind').'</center><table><tr><th><img src="source/plugin/dsu_paulsign/img/emot/'.$days[$postlist[$key][authorid]][qdxq].'.gif"><th><font>'.$days[$postlist[$key][authorid]][qdxqzw].'</font><br>'.$days[$postlist[$key][authorid]][time].'</tr></table></li></div>';
