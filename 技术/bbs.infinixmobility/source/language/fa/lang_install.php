...
$lang = array(
	...
	'title_install'		=> SOFT_NAME.'نصب دیسکاز',//SOFT_NAME.' 安装向导',
	...
	'writeable'		=> 'قابل نوشتن',//'可写',
	'unwriteable'		=> 'غیرقابل نوشتن',//'不可写',
	'old_step'		=> 'مرحله قبل',//'上一步',
	'new_step'		=> 'مرحله بعد',//'下一步',
	...
	'step_title_1'		=> 'بررسی سرور',//'检查安装环境',
	'step_title_2'		=> 'تنظیمات سرور',//'设置运行环境',
	'step_title_3'		=> 'ساخت دیتابیس',//'创建数据库',
	'step_title_4'		=> 'نصب',//'安装',
	'step_env_check_title'	=> 'شروع نصب',//'开始安装',
	'step_env_check_desc'	=> 'بررسی وضعیت سرور،فایل ها و دسترسی ها',//'环境以及文件目录权限检查',
	'step_db_init_title'	=> 'نصب دیتابیس',//'安装数据库',
	'step_db_init_desc'	=> 'تنظیمات دیتابیس و مدیر کل',//'正在执行数据库安装',

	'step1_file'		=> 'لیست فایلها',//'目录文件',
	'step1_need_status'	=> 'الزامی',//'所需状态',
	'step1_status'		=> 'وضعیت',//'当前状态',
	'not_continue'		=> 'Please, try to repair positions marked by a red cross',//'请将以上红叉部分修正再试',

	'tips_dbinfo'		=> 'تنظیمات دیتابیس',//'填写数据库信息',
	'tips_dbinfo_comment'	=> '',//'',
	'tips_admininfo'	=> 'تنظیمات مدیریت',//'填写管理员行数据信息',
	'step_ext_info_title'	=> 'با موفقیت نصب شد',//'安装成功。',
	'step_ext_info_comment'	=> 'برای ورود کلیک کنید',//'点击进入登录',
	...
	'sitename'			=> 'نام سایت',//'站点名称',
	'siteurl'			=> 'آدرس سایت',//'站点 URL',
...
/*vot*/	'install_dzfull'		=> ' UCenter نسخه کامل دیسکاز شامل ماژول',//'全新安装 Discuz! X (含 UCenter Server)',
/*vot*/	'install_dzonly'		=> ' UCenter نسخه کامل دیسکاز بدون ماژول',//'仅安装 Discuz! X (手工指定已经安装的 UCenter Server)',

	'username'			=> 'نام کاربری مدیر کل',//'管理员账号',
	'email'				=> 'ایمیل مدیر کل',//'管理员 Email',
	'password'			=> 'رمز ورود مدیر کل',//'管理员密码',
	'password_comment'		=> 'رمز ورود مدیر کل نمیتواند خالی بماند',//'管理员密码不能密码为空',
	'password2'			=> 'تکرار رمز ورود',//'重复密码',
	...
	'install_in_processed'		=> 'در حال نصب',//'正在安装...',
	'install_succeed'		=> 'نصب با موفقیت پایان یافت برای ورود به انجمن اینجا کلیک کنید',//'安装成功，点击进入',
	...
	'to_install_cloud'		=> 'ورود به پنل مدیر',//'到后台开通',
...
<p>Between Hong Sing if you and any dispute or controversy, should first be settled through friendly consultations, the consultation fails, you hereby agree to submit the dispute or controversy Sing Haidian District People\'s Court where jurisdiction. Hong Sing Company has the right to interpret the above terms and discretion.</p>
	...
	'project'		=> 'Project',//'项目',
	'ucenter_required'	=> 'حداقل',//'Discuz! 所需配置',
	'ucenter_best'		=> 'پیشنهاد شده',//'Discuz! 最佳',
	'curr_server'		=> 'وضعیت کنونی',//'当前服务器',
	'env_check'		=> 'بررسی وضعیت عمومی سرور',//'环境检查',
	...
	'check_result'		=> 'نتایج بررسی توابع',//'检查结果',
	...
	'tablepre'		=> 'پیشوند جداول',//'数据表前缀',

	'ucfounderpw'		=> 'رمز ورود UCenter',//'创始人密码',
	'ucfounderpw2'		=> 'تکرار دوباره رمز ورود UCenter',//'重复创始人密码',

	'init_log'		=> 'Initialize log',//'初始化记录',
	'clear_dir'		=> 'Clear directory',//'清空目录',
	'select_db'		=> 'انتخاب دیتابیس',//'选择数据库',
	'create_table'		=> 'ساخت جدول',//'建立数据表',
	'succeed'		=> 'Success',//'成功 ',
	...
	'skip_current'			=> 'نادیده گرفتن این مرحله',//'跳过本步',
	'topic'				=> 'Topic',//'专题',
	'install_finish'		=> '.عملیات نصب موفقیت آمیز بود برای ورود به انجمن اینجا کلیک کنید',//'您的论坛已完成安装，点此访问',

//---------------------------------------------------------------
// Added by Valery Votintsev
// 2 vars for language select:
	'welcome'			=> 'به نصب دیسکاز خوش آمدید',//'欢迎到Discuz！ X安装！',
	'select_language'		=> '<b>لطفا زبان نصب را انتخاب نمایید</b>:',//'<b>选择安装语言</b>',
