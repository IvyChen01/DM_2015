...
$lang = array (
  ...
  array (
    'index' =>
    array (
      'صفحه اصلی پنل مدیریت' => 'action=index',
    ),
    'text' =>
    array (
      0 => 'کنترل پنل مدیریت',//'管理中心首页',
    ),
  ),
  1 =>
  array (
  ...
  array (
    ...
    'text' =>
    array (
      0 => 'تنظیمات دسترسی های موبایل',//'手机版访问设置',
    ),
  ),
  22 =>
  array (
  ...
  array (
    ...
    'text' =>
    array (
      0 => 'چک کردن دسترسی های فایل ',//'文件权限检查',
    ),
  ),
  136 =>
  array (
  ...
  array (
    ...
    array (
      ...
      3 => 'blog_search_perpage',
      4 => 'Number of lines per page',//'每页显示数显示',
      5 => 'resultsort',
      6 => 'Sort order',//'结果排序',
      7 => 'blog_search_uid',
      8 => 'User UID',//'用户 UID',
...
//由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。你可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置你的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。你使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
  ...
  array (
    ...
    array (
      ...
      5 => 'Whether to allow the Magic Center functions',//'是否开启道具中心否开启功能',
...
//',
  ...
  array (
    ...
    array (
      ...
      2 => 'Broadcast archive time',//'广播存档时间discuz.ir',
  ...
  array (
    ...
    array (
      ...
      23 => 'Set to use points for products threads',//'设置商品主题章使用使用的积分',
...
<br />(3) SPH_RANK_NONE, Disable ranking mode, which is the fastest mode. Fact that the same model as a Boolean search. All the matches are given weight 1.',
  ...
  array (
    ...
    'text' =>
    array (
      0 => 'گروه کاربری &raquo;تنظیمات اولیه',//'用户组 &raquo; 基本设置',
      1 => 'usergroups_edit_basic',
      2 => 'تنظیمات اولیه',//'基本设置',
      3 => 'usergroups_edit_basic_title',
      4 => 'عنوان گروه کاربری',//'用户组头衔',
      5 => 'usergroups_icon',
      6 => 'آیکون گروه',//'组图标',
      7 => 'usergroups_edit_basic_visit',
      8 => 'اجازه دسترسی به سایت',//'访问站点权限',
      ...
      35 => 'اجازه به استفاده از کد HTML',//'允许使用 HTML 代码',
      ...
      46 => 'اجازه استفاده از جستجو',//'允许使用搜索',
