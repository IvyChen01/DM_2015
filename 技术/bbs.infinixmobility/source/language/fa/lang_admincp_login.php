...
$lang = array
(
	'login_title'		=> 'ورود به کنترل پنل مدیر کل',//'登录管理中心',
	'login_username'	=> 'نام کاربری',//'用户名',
	'login_password'	=> 'رمز عبور',//'密　码',

	'submit'		=> 'ثبت',//'提交',
	'forcesecques'		=> 'الزامی',//'必填项',
	'security_question'	=> 'سوال امنیتی',//'提　问',
	'security_answer'	=> 'جواب',//'回　答',
	'security_question_0'	=> 'بدون سوال امنیتی',//'无安全提问',
	'security_question_1'	=> 'نام مادر',//'母亲的名字',
	'security_question_2'	=> 'نام پدربزرگ',//'爷爷的名字',
	'security_question_3'	=> 'شهری که پدرتان به دنیا آمده',//'父亲出生的城市',
	'security_question_4'	=> 'نام اولین معلم شما',//'您其中一位老师的名字',
	'security_question_5'	=> 'مدل کامپیوتر شما',//'您个人计算机的型号',
	'security_question_6'	=> 'رستوران مورد علاقه شما',//'您最喜欢最的餐最馆名称',
	'security_question_7'	=> 'سال تولد شما',//'驾驶执照的最后四位数字',
