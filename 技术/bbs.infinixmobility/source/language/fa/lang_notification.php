...
(
	...
	'type_wall'		=> 'پیغام دیوار',//'留言',
	'type_piccomment'	=> 'نظر در تصویر',//'图片评论',
	'type_blogcomment'	=> 'نظر در وبلاگ',//'日志评论',
	'type_clickblog'	=> 'Blog positioning',//'日志表态',
	'type_clickarticle'	=> 'Article positioning',//'文章表态',
	'type_clickpic'		=> 'Image positioning',//'图片表态',
	'type_sharecomment'	=> 'نظر در اشتراک گذاری',//'分享评论',
	'type_doing'		=> 'فعالیت ها',//'记录',
	'type_friend'		=> 'دوستان',//'好友',
	'type_credit'		=> 'پول',//'积分',
	'type_bbs'		=> 'انجمن',//'论坛',
	'type_system'		=> 'سیستم',//'系统',
	'type_thread'		=> 'موضوعات',//'主题',
	'type_task'		=> 'وظایف',//'任务',
	'type_group'		=> 'گروه ها',//'群组',
	...
	'group_member_join'	=> '{actor} میخواهد در گروه شما عضو شود <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a>, لطفا او را مدیریت کنید <a href="{url}" target="_blank">در پنل گروه</a>',//'{actor} 加入你的群组需要审核，请到群组 <a href="{url}" target="_blank">管理后台</a> 进行审核',
	'group_member_invite'	=> '{actor} شما را به گروهش دعوت کرده است <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a>, <a href="{url}" target="_blank">برای پیوستن به گروه اینجا کلیک کنید</a>',//'{actor} 邀请你加入 <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a> 群组，<a href="{url}" target="_blank">点此马上加入</a>',
	'group_member_check'	=> 'شما درخواست عضویت در این گروه را دارید <a href="{url}" target="_blank">{groupname}</a> تایید شد <a href="{url}" target="_blank">برای مشاهده اینجا کلیک کنید</a>',//'你已经通过了 <a href="{url}" target="_blank">{groupname}</a> 群组的审核，请 <a href="{url}" target="_blank">点击访问</a>',
	'group_member_check_failed'	=> 'گروه شما <a href="{url}" target="_blank">{groupname}</a> تایید نمیشود',//'你没有通过 <a href="{url}" target="_blank">{groupname}</a> 群组的审核。',
	'group_mod_check'		=> 'گروهی که شما ایجاد کرده اید "<a href="{url}" target="_blank">{groupname}</a>" تایید شد <a href="{url}" target="_blank">برای مشاهده اینجا کلیک کنید</a>',//'您的创建的群组 <a href="{url}" target="_blank">{groupname}</a> 审核通过了，请 <a href="{url}" target="_blank">点击这里访问</a>',

	'reason_moderate'	=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> was {modaction} by {actor} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} {modaction} <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_merge'		=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> was {modaction} by {actor} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} {modaction} <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_delete_post'	=> 'پست شما در <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> بوسیله {actor} حذف شد <div class="quote"><blockquote>{reason}</blockquote></div>',//'你在 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的帖子被 {actor} 删除 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_delete_comment'	=> 'نظر شما در <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a> بوسیله {actor} حذف شد <div class="quote"><blockquote>{reason}</blockquote></div>',//'你在 <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a> 的点评被 {actor} 删除 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_ban_post'	=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> was {modaction} by {actor} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} {modaction} <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'reason_move'		=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> انتقال داده شد به <a href="forum.php?mod=forumdisplay&fid={tofid}" target="_blank">{toname}</a> توسط {actor} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 移动到 <a href="forum.php?mod=forumdisplay&fid={tofid}" target="_blank">{toname}</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_copy'		=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> کپی شد از <a href="forum.php?mod=viewthread&tid={threadid}" target="_blank">{subject}</a> توسط {actor} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 复制为 <a href="forum.php?mod=viewthread&tid={threadid}" target="_blank">{subject}</a> <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'reason_stamp_delete'	=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> مهرش بوسیله {actor} پاک شد<div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 撤销了图章 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stamplist_update'	=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> by {actor} added the icon {stamp} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 添加了图标 {stamp} <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stamplist_delete'	=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> by {actor} revoked the icon <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 撤销了图标 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stickreply'		=> 'پاسخ شما به موضوع <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> مهم شد بوسیله {actor}. <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stickdeletereply'	=> 'پاسخ شما در موضوع <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> از حالت مهم خارج شد بوسیله {actor} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你在主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的回帖被 {actor} 撤销置顶 <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'modthreads_delete'	=> 'موضوع شما {threadsubject} تایید نشد و حذف شد. <div class="quote"><blockquote>{reason}</blockquote></div>',//'你发表的主题 {threadsubject} 没有通过审核，现已被删除！<div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'modthreads_validate'	=> 'موضوع شما <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> تایید شد. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">Click to view it &rsaquo;</a>',//'你发表的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{threadsubject}</a> 已经审核通过！ &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
	...
	'user_usergroup'	=> 'گروه کاربری شما ارتقا داده شد به {usergroup}. &nbsp; <a href="home.php?mod=spacecp&ac=usergroup" target="_blank" class="lit">نمایش دسترسی های من</a>',//'你的用户组升级为 {usergroup} &nbsp; <a href="home.php?mod=spacecp&ac=credit&op=usergroup" target="_blank" class="lit">看看我能做什么 &rsaquo;</a>',
	...
	'invite_friend'		=> 'شما دعوت شدید و با موفقیت به دوستان کاربر {actor} اضافه شدید.',//'恭喜你成功邀请到 {actor} 并成为你的好友',

	'poke_request'		=> '<a href="{fromurl}" class="xi2">{fromusername}</a> ارسال خوش آمد گویی: <span class="xw0">{pokemsg}&nbsp;</span><a href="home.php?mod=spacecp&ac=poke&op=reply&uid={fromuid}&from=notice" id="a_p_r_{fromuid}" class="xw1" onclick="showWindow(this.id, this.href, \'get\', 0);">پاسخ به خوش آمدگویی</a><span class="pipe">|</span><a href="home.php?mod=spacecp&ac=poke&op=ignore&uid={fromuid}&from=notice" id="a_p_i_{fromuid}" onclick="showWindow(\'pokeignore\', this.href, \'get\', 0);">Ignore</a>',//'<a href="{fromurl}" class="xi2">{fromusername}</a>: <span class="xw0">{pokemsg}&nbsp;</span><a href="home.php?mod=spacecp&ac=poke&op=reply&uid={fromuid}&from=notice" id="a_p_r_{fromuid}" class="xw1" onclick="showWindow(this.id, this.href, \'get\', 0);">回打招呼</a><span class="pipe">|</span><a href="home.php?mod=spacecp&ac=poke&op=ignore&uid={fromuid}&from=notice" id="a_p_i_{fromuid}" onclick="showWindow(\'pokeignore\', this.href, \'get\', 0);">忽略</a>',
	...
	'member_ban_visit'		=> 'شما محروم شده اید بوسیله {user} برای {day} روز (0 به معنی محرومیت دائمی است). دلیل محرومیت: {reason}',//'您已被 {user} 禁止访问，期限：{day}天(0：代表永久禁止访问)，禁止访问理由：{reason}',
	'member_ban_status'		=> 'شما محروم شده ای بوسیله {user}, دلیل محرومیت {reason}',//'您已被 {user} 锁定，禁止访问理由：{reason}',
	...
	'member_follow_add'		=> '{actor} شما را دنبال میکند. <a href="home.php?mod=follow&do=follower">برای مشاهده کلیک کنید</a>',//'{actor} 收听了你。<a href="home.php?mod=follow&do=follower">Click to view</a>',

	'member_moderate_invalidate'	=> 'حساب کاربری شما توسط مدیریت تایید نشد لطفا <a href="home.php?mod=spacecp&ac=profile">اطلاعات عضویت خود را دوباره وارد کنید</a>.<br />سخن مدیر: <b>{remark}</b>',//'你的账号未能通过管理员的审核，请<a href="home.php?mod=spacecp&ac=profile">重新提交注册信息</a>。<br />管理员留言: <b>{remark}</b>',
	'member_moderate_validate'	=> 'حساب کاربری شما فعال شد.<br />سخن مدیر: <b>{remark}</b>',//'你的账号已经通过审核。<br />管理员留言: <b>{remark}</b>',
	'member_moderate_invalidate_no_remark'	=> 'حساب کاربری شما توسط مدیریت تایید نشد لطفا <a href="home.php?mod=spacecp&ac=profile">اطلاعات عضویت خود را دوباره وارد کنید</a>.',//'你的账号未能通过管理员的审核，请<a href="home.php?mod=spacecp&ac=profile">重新提交注册信息</a>。',
	'member_moderate_validate_no_remark'	=> 'حساب کاربری شما فعال شد.',//'你的账号已经通过审核。',
