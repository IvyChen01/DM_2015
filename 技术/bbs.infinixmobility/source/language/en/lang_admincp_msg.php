...
/*3.2*/	'two_domain_have_been_occupied'	=> 'Sorry, this subdomain name has been occupied',//'抱歉，二级域名已被占用',
	...
	'ecommerce_must_larger'		=> 'Rating {rank} of the Xpoint must be greater than in the previous level! Return to modify.',//'信用等级 {rank} 的信用度必须大于上一等级的信用度！请返回修改。',
	'ec_credit_succeed'		=> 'System Xpoint rate successfully set.',//'信用评价体系成功设定。',
