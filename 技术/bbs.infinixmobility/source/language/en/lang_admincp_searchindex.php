...
$lang = array (
  ...
  array (
    ...
    array (
      ...
      21 => 'If you sign the agreement contains pure instant arrive interface (not the standard dual-interface) can choose this, so that integration can only recharge Instant Xpoint Payment',//'如果你的签约协议中包含纯即时到帐接口（不是标准双接口）可以选择此项，让积分充值只能使用即时到账方式付款',
    ),
  ),
  184 =>
  array (
...
//由于涉及现金交易，为避免因操作不当而造成的资金损失，请在开始使用财付通积分交易功能(不包含财付通按钮功能)前，务必仔细阅读《用户使用说明书》中有关电子商务的部分，当确认完全理解和接受相关流程及使用方法后再进行相关设置。你可以设置允许用户通过现金在线支付的方式，为其交易积分账户充值，用于购买帖子内容、购买用户组权限、积分转账或用户组升级等功能。财付通积分交易功能，需在“积分设置”中启用交易积分，并同时设置相应的积分策略以满足不同场合的需要。请务必正确设置你的收款财付通账号，否则将造成用户付款后积分无法实时到账，造成大量需要人工处理的订单信息。除 Discuz! 官方网站或官方论坛另行通知以外，Discuz! 提供的财付通支付服务每笔交易收取 1% 的手续费。请及时关注相关业务的最新通知，各项政策或流程的变更、调整，以 Discuz! 官方网站或官方论坛提供的信息为准。你使用财付通服务是建立在完全自愿的基础上，除 Discuz! 因主观恶意的因素造成的资金损失以外，北京康盛新创科技有限责任公司不对因使用此功能造成的任何损失承担责任。财付通服务热线：0755-83762288-2(全天24小时服务热线)',
      ...
      13 => 'TenPay Instant Xpoint Merchant No.',//'财付通即时到账商户号',
  ...
  array (
    ...
    'text' =>
    array (
      0 => 'E-Commerce &raquo; Xpoint Rules',//'电子商务 &raquo; 诚信规则',
      1 => 'ec_Xpoint_tips',
      ...
      3 => 'ec_Xpoint',
      4 => 'Xpoint Rules',//'诚信规则',
      5 => 'ec_Xpoint_maxcreditspermonth',
...
//',
  ...
  array (
    ...
    array (
      ...
      11 => 'setting_access_register_invite_Xpoint',
  ...
  array (
    ...
    array (
      ...
      40 => 'Xpoint reminder lower limit',//'提醒添加桌面快捷的积分下限',
      41 => 'If a user Xpoints are not less than this limit, then the Xpoint reminder will be shown at the top bar reminder. Leave empty or set to 0 for disable this feature.',//'大于等于设置积分的用户将看到添加桌面快捷的顶部提醒，0或不填为关闭此功能',
  ...
  array (
    ...
    array (
      ...
      10 => 'setting_functions_activity_Xpoint',
  ...
  array (
    ...
    'text' =>
    array (
      0 => 'Xgold Setttings &raquo; Base settings',//'积分设置 &raquo; 基本设置',
      1 => 'setting_Xpoints_extended',
      ...
      4 => 'setting_Xpoints',
      5 => 'Xgold Setttings',//'积分设置',
      6 => 'setting_Xpoints_trans',
      ...
      18 => 'setting_Xpoints_trans3',
      19 => 'Magics, decorations used Xpoints',//'道具、勋章使用的积分',
      20 => 'Set magics, decorations used Xpoints',//'设置道具、勋章中使用的积分',
      21 => 'setting_Xpoints_trans5',
      22 => 'Products points',//'商品主题使用的积分',
      23 => 'Set to use points for products threads',//'设置商品主题使用的积分',
      24 => 'setting_Xpoints_trans6',
      25 => 'Space consumption points',//'空间消费使用的积分',
      26 => 'Set to use points in space consumtion',//'设置在空间中消费使用的积分类型',
      27 => 'setting_Xpoints_trans7',
      ...
      36 => 'setting_Xpoints_trans11',
      37 => 'Grab floor points limit',//'抢楼帖积分限制',
      38 => 'Minimum number of points for participate in grab floor post',//'参与抢楼帖积分限制时使用的积分',
      39 => 'setting_Xpoints_trans12',
      40 => 'Consume Xpoints for group creation',//'创建群组消耗积分',
      41 => 'How many Xpoints decreased when a group created',//'创建群组时要消耗的积分',
      42 => 'setting_Xpoints_tax',
      ...
      45 => 'setting_Xpoints_mintransfer',
      ...
      48 => 'setting_Xpoints_minexchange',
      ...
      51 => 'setting_Xpoints_maxincperthread',
      ...
      54 => 'setting_Xpoints_maxchargespan',
...
<br />(3) SPH_RANK_NONE, Disable ranking mode, which is the fastest mode. Fact that the same model as a Boolean search. All the matches are given weight 1.',
  ...
  array (
    ...
    array (
      ...
      1 => 'setting_ec_Xpointtrade',
      2 => 'Points Exchange settings',//'积分兑换设置',
      3 => 'setting_ec_ratio',
      4 => 'Xgold/points exchange ratio',//'现金/积分兑换比率',
      5 => 'Set an exchange ratio between the real Xgold cash (in USD) and intenal points. For example, if is set to 10, 1 USD can be exchanged to 10 points. This feature is required to enable sale operations with points, and an access to the related external paymet system (i.e. Alipay). Set to 0 for prohibit the use of cash and a conversion to points.',//'设置真实货币现金(以人民币元为单位)与站点交易积分间的兑换比率，例如设置为 10，则 1 元人民币可以兑换 10 个单位的交易积分。本功能需开启交易积分，并成功进行支付宝收款账号的相关设置后方可使用，如果禁止使用现金与交易积分的兑换功能，请设置为 0',
  ...
  array (
    ...
    array (
      ...
      1 => 'usergroups_edit_Xpoint',
      2 => 'Points related',//'积分相关',
      3 => 'usergroups_edit_Xpoint_exempt_sendpm',
      4 => 'Not decrease points for Send PM',//'发短消息不扣积分',
      5 => 'usergroups_edit_Xpoint_exempt_search',
      6 => 'Not decrease points for Search',//'搜索不扣积分',
      7 => 'usergroups_edit_Xpoint_exempt_getattch',
      8 => 'Not decrease points for download attachments',//'下载附件不扣积分',
      9 => 'usergroups_edit_Xpoint_exempt_attachpay',
      10 => 'Direct download attachment fee',//'可直接下载收费附件',
      11 => 'usergroups_edit_Xpoint_exempt_threadpay',
  ...
  array (
    ...
    array (
      ...
      7 => 'Need Xpoints for Create group',//'创建群组消耗积分',
      8 => 'How many Xpoints required for Creating a group. Set to 0 for do not require Xpoints',//'创建群组需要消耗和积分数量，0为不需要积分',
