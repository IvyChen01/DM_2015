...
{siteurl}</p>',
	...
	'email_sendverified_subject' =>	'Email activation thing',//'邮箱激活件',
		'email_sendverified_message' =>	'<br />
	
		
<p>The letter was sent by {bbname}.</p>
...
< p > if you are {bbname} new users, or modify your registered Email using this address, we need to To validate effectiveness of your address to avoid spam or address being abused. < / p > 
		< p > this is an email activation test < / p >
		 < p > you only need to click the link below to go to the user activated, the following links will remain open for 3 days. Expiration can request a new E-mail validation: < br / >
...
(if not link above, please send the address manually paste into a browser address bar to access) < / p >
		
		
		
< p > thank you for your visit, I wish you a happy to use! < / p >
