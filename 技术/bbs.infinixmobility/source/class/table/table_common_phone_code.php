...
class table_common_phone_code extends discuz_table
{

	public function __construct() {

		$this->_table = 'common_phone_code';
		$this->_pk    = 'id';
	...
	/**
	     ...
	     * @return return_type
	     * @author : yanhui.chen
	     * @date: 2016年3月1日 下午2:33:08
	     */
	public function fetch_all_by_phone($phone){
	    $sql = 'SELECT * FROM %t WHERE phone='.$phone;
	...
	/**
	     ...
	     * @return return_type
	     * @author : yanhui.chen
	     * @date: 2016年3月1日 下午3:19:07
	     */
	public function delete_by_phone($phone){
	    DB::query("DELETE FROM %t WHERE phone=%s",array($this->_table, $phone)); 
	}    
}
