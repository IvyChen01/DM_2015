...
class table_common_member_profile extends discuz_table_archive
{
	...
	/**
	     * @Description: 查找相同国籍的手机号码等信息
	     * @param variable $nation
	     * @return return_type array
	     * @author : yanhui.chen
	     * @date: 2015年5月9日 上午10:11:36
	     */
	    public function fetch_info_by_nation($param) {
	        return DB::fetch_all('select uid,mobile FROM %t WHERE nationality=%s',array($this->_table,$param),$this->_pk);
	    }
	    /**
	    * Copyright @ 2013 Infinix. All rights reserved.
	    * ==============================================
	    * @Description :根据uid获取用户性别
	    * @date: 2015年7月13日 下午4:02:21
	    * @author: yanhui.chen
	    * @version:
	    */
	    public function get_sex_by_uid($uid) {
	        return DB::fetch_first('select gender FROM %t WHERE uid=%s',array($this->_table,$uid),$this->_pk);
	    }
}
