...
<div id="btoolbar" class="btoolbar btoolbarv">
    ...
    <ul>
        <li class="li1">
       <a class="a1" href="javascript:;" style="display:block;"><input type="file" name="Filedata" id="filedata" style="width:30px;height:30px;font-size:30px;opacity:0;" accept="image/*" capture="camera" /></a>
        <a class="a2"></a>
        <div id="fastsmiliesdiv_data" style="display:none;"><div id="fastsmilies"></div></div>
        </li>
		<li class="li2">
            <textarea value="{lang send_reply_fast_tip}"  name="message" id="fastpostmessage" fwin="reply" autocomplete="off" placeholder="content at least 10 BYTES"></textarea>
	...
	function succeedhandle_fastpost(locationhref, message, param) {
		...
		if(pid) {
			...
			.success(function(s) {
                ...
                var post_new = $(s.lastChild.firstChild.nodeValue);
                    post_new.find(".orange").attr("href",post_new.find(".orange").attr("href") + "&mobile=2");
				$('#post_new').append(post_new);
...
<script type="text/javascript">
	...
	$(document).on('change', '#filedata', function() {
			...
			if(typeof FileReader != 'undefined' && this.files[0]) {
				...
				if ( ext_name.length = 1 || imgexts.indexOf(ext_name.pop()) > -1)
				{	
