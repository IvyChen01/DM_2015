...
/*vot*/				selector += '<option value="'+i+'" '+ (i == curpage ? 'selected' : '') +'>'+i+'</option>';
			}
			selector += '</select>';
/*vot*/			selector += '<span>'+curpage+'</span>';
		}

/*vot*/		$('div.pg').removeClass('pg').addClass('page').html('<a href="'+ prevpagehref +'">'+lng['prev_page']+'</a>'+ selector +'<a href="'+ nextpagehref +'">'+lng['next_page']+'</a>');
...
/*vot*/				pop = '<div class="tip"><dt>'+ pop +'</dt><dd><input class="button2" type="button" value="'+lng['submit']+'" onclick="popup.close();"></dd></div>'
				...
				pop = '<div class="tip"><dt>'+ pop +'</dt><dd><input class="button2" type="button" value="'+lng['close']+'" onclick="popup.close();"></dd></div>';
			}
...
/*vot*/				pop = '<div class="tip"><dt>'+ pop +'</dt><dd><input class="redirect button2" type="button" value="'+lng['submit']+'" href="'+ url +'"><a href="javascript:;" onclick="popup.close();">'+lng['cancel']+'</a></dd></div>'
			...
			$('body').append('<div id="ntcmsg" style="display:none;font-size:15px;">'+ pop +'</div>');
			pop = $('#ntcmsg');
		}
		...
		popupobj.css({'display':'block','position':'absolute','position':'fixed','left':left,'top':top,'z-index':10000,'opacity':1,"background":"#FFF","font-size":"15px","text-align":"center",});
