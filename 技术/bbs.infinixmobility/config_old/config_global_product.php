...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = '172.18.10.10';
$_config['db']['1']['dbuser'] = 'root';
$_config['db']['1']['dbpw'] = '21a2601293';
...
$_config['output']['iecompatible'] = '';

// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'OAN8_';
...
$_config['languages']['fa']['name'] = 'Farsi';
...
$_config['languages']['ui']['name'] = 'Uyghur';
