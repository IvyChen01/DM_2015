package com.geyaa.lib
{
	...
	public class MyDebug
	{
		 ...
		 */
		public static function init(aContainer:DisplayObjectContainer, aStage:Stage, aEnabled:Boolean = true, aDebugKey:uint = 192, aTextSize:int = 18, aTextColor:int = 0x00FF00, aWidth:Number = 400, aHeight:Number = 400):void
		{
		 ...
		 * @param	value
		 */
		public static function echo(value:String):void
		{
			if (_enabled)
			{
				_id++;
