            ...
            <div class="container">
                ...
                <div class="row titlerow">
                    <h3 class="sectiontitle wow fadeInDown text-center" style="width: 100%;" data-wow-duration="700ms" data-wow-delay="300ms">
                        <?php
                                if ( is_day() ) :
                                        printf( __( 'Daily Archives: %s', 'doors' ), get_the_date() );

                                elseif ( is_month() ) :
                                        printf( __( 'Monthly Archives: %s', 'doors' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'doors' ) ) );

                                elseif ( is_year() ) :
                                        printf( __( 'Yearly Archives: %s', 'doors' ), get_the_date( _x( 'Y', 'yearly archives date format', 'doors' ) ) );
