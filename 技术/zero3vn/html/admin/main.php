...
<div class="main">
	...
	<ul>
		<li>
			<a href="?m=adminNews" title="新闻管理" target="_self">新闻管理</a>
		</li>
		<li>
			<a href="?m=adminHongBao&a=luckyCount" title="抢红包统计" target="_self">抢红包统计</a>
		</li>
		<li>
			<a href="?m=adminHongBao&a=winlist" title="抢红包中奖名单" target="_self">抢红包中奖名单</a>
		</li>
		<li>
