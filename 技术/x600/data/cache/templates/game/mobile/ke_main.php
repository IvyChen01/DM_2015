...
<link href="css/mobile_index.css?v=2015.12.8_22.23" rel="stylesheet" type="text/css" />
...
<script src="js/mobile_game.js?v=2015.12.9_14.58" type="text/javascript" language="javascript"></script>
</head>
...
<div class="info">
	...
	<p class="date"><span class="year">2015</span>&nbsp; 12.09 ~ 12.20</p>
	<p class="desc">To celebrate the launch of Infinix NOTE 2<br /> 
		and welcome the InfiniXmas Season,<br />
		we are having a "Spin The InfiniXmas Wheel,<br />
		Win Infinix NOTE 2" competition to give away
		Infinix NOTE 2 and some other Infinix gifts.</p>
</div>
<div class="pan">
