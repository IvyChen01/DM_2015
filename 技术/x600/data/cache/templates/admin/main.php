...
<div class="main">
	...
	<ul>
		<li>
			<a href="./?m=adminGame&a=winList" title="中奖名单" target="_self">中奖名单</a>
		</li>
		<li>
			<a href="./?m=adminGame&a=dataCount" title="抽奖统计" target="_self">抽奖统计</a>
		</li>
		<li>
			<a href="./?m=adminGame&a=userList" title="用户列表" target="_self">用户列表</a>
		</li>
		<li>
