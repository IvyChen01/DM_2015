...
public class AddFriendsAdapter extends BaseAdapter {
	...
	private static int[] mImageIds = new int[] {R.drawable.af_headprotriat_1,R.drawable.af_headprotriat_2,
		R.drawable.af_headprotriat_3,R.drawable.af_headprotriat_4,R.drawable.af_headprotriat_5,R.drawable.af_headprotriat_6,};

	public AddFriendsAdapter(Context context,ArrayList<FriendInformation> moreNews){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder mHolder;
		if(view==null){
			view=inflater.inflate(R.layout.add_friends_item, null);
		...
		mHolder.tvPresent.setText(friend.getPresent());
