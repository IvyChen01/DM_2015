...
class ZhuanPan
{
	...
	public function initPrize()
	{
		...
		$tbZpJiangChi = Config::$tbZpJiangChi;
		Config::$db->query("delete from $tbZpJiangChi");
		Config::$db->query("insert into $tbZpJiangChi (prizedate, rate, prize1, prize2, prize3) values ('2015-12-8', 20, 2, 3, 12)");
		Config::$db->query("insert into $tbZpJiangChi (prizedate, rate, prize1, prize2, prize3) values ('2015-12-9', 20, 1, 3, 12)");
		Config::$db->query("insert into $tbZpJiangChi (prizedate, rate, prize1, prize2, prize3) values ('2015-12-10', 20, 1, 2, 12)");
		Config::$db->query("insert into $tbZpJiangChi (prizedate, rate, prize1, prize2, prize3) values ('2015-12-11', 20, 1, 2, 12)");
		Config::$db->query("insert into $tbZpJiangChi (prizedate, rate, prize1, prize2, prize3) values ('2015-12-12', 20, 1, 2, 12)");
	...
	public function getPageWinner($page)
	{
		...
		{
			case 1:
				$pageDate = Utils::mdate('Y-m-d', '2015-12-8');
				break;
			case 2:
				$pageDate = Utils::mdate('Y-m-d', '2015-12-9');
				break;
			case 3:
				$pageDate = Utils::mdate('Y-m-d', '2015-12-10');
				break;
			case 4:
				$pageDate = Utils::mdate('Y-m-d', '2015-12-11');
				break;
			case 5:
				$pageDate = Utils::mdate('Y-m-d', '2015-12-12');
				break;
			default:
		}
		$res = array();
