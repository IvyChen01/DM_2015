(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: domainURL + '/index.php?m=Home&c=shops&a=uploadPic',
            // runtimeOrder: 'flash',
            fileVal:'Filedata',
             accept: {
                 title: 'Images',
        ...
        function addFile( file ) {
            ...
            file.on('statuschange', function( cur, prev ) {
                ...
                if ( cur === 'error' || cur === 'invalid' ) {
                    ...
                    $li.append( '<span class="setdef" style="display:none;">默认</span><span class="setdel" style="display:none;">删除</span>' );
