(function( $ ){
    ...
    $(function() {
        var $wrap = $('#uploader'),
            ...
            state = 'pedding',
            publicurl ='http://www.tecno-mobile.com/Public/Js',
            domainURL = 'http://www.tecno-mobile.com'
        ...
        if ( !WebUploader.Uploader.support('flash') && WebUploader.browser.ie ) {
            ...
            if (flashVersion) {
                (function(container) {
                    ...
                    var swf = publicurl +'/webuploader/expressInstall.swf';
                    // insert flash object
        ...
        uploader = WebUploader.create({
            ...
            paste: '#uploader',
            swf: publicurl +'/webuploader/Uploader.swf',
            chunked: false,
            chunkSize: 512 * 1024,
            server: domainURL + '/index.php?m=Admin&c=goods&a=uploadPic',
            // runtimeOrder: 'flash',
            fileVal:'Filedata',
             accept: {
                 title: 'Images',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax(publicurl +'/webuploader/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
