<?php if (!defined('THINK_PATH')) exit();?><div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="<?php echo U($Think.ACTION_NAME);?>" method="post">
        ...
        <div class="bjui-searchBar">
            <label><?php echo (L("user_name")); ?>：</label><input type="text" name="search[loginName]" value="<?php echo ($search["loginName"]); ?>" class="form-control" size="10" />
            <label><?php echo (L("user_id")); ?>：</label><input type="text" name="search[userId]" value="<?php echo ($search["userId"]); ?>" class="form-control" size="10" /></li>
            ...
            <div class="pull-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu right" role="menu">
                        <li><a href="<?php echo U('addUser');?>" data-toggle="dialog" data-width="650" data-height="500" data-id="dialog-mask" data-mask="true"><?php echo (L("new_add")); ?></a></li></ul>
                </div>
            </div>
        </div>
    </form>
...
<div class="bjui-pageContent">
    ...
    <table data-toggle="tablefixed" data-width="100%" data-nowrap="true">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><!-- <tr aid="<?php echo ($vo["aid"]); ?>">
                ...
                <td>
                    <?php if($vo["email"] == C('ADMIN_AUTH_KEY')): else: ?><a href="/index.php/Admin/Users/editAdmin/uid/<?php echo ($vo["uid"]); ?>" data-toggle="modal" data-target="#myModal">编辑</a><?php endif; ?> 
                </td>
            </tr> -->
            <tr aid="<?php echo ($vo["userId"]); ?>">
				...
				<td>
				    <a class="btn btn-default glyphicon glyphicon-pencil" href="<?php echo U('edit',array('uid' => $vo['userId']));?>" data-toggle="dialog" data-width="650" data-height="500" data-id="dialog-mask" data-mask="true"><?php echo (L("edit")); ?></a>
				    <a class="btn btn-red glyphicon glyphicon-trash" data-confirm-msg="<?php echo (L("delete_confirm")); ?>" data-toggle="doajax" href="<?php echo U('del',array('uid' => $vo['userId']));?>"><?php echo (L("delete")); ?></a>
				</td>
...
<script type="text/javascript">
    ...
    $('#myModal').on('shown.bs.modal', function () {
        ...
        $(".submitForm").click(function() {
            var url;
            if ($("#pk").val()){
                url = '/index.php/Admin/Users/editAdmin';
            } else {
                ...
                url = '/index.php/Admin/Users/addAdmin';
            }
