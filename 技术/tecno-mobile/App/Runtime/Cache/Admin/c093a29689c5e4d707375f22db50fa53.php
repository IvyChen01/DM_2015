<?php if (!defined('THINK_PATH')) exit();?>   <div class="bjui-pageHeader">
	<form id="pagerForm" data-toggle="ajaxsearch" action="<?php echo U($Think.ACTION_NAME);?>" method="post">
     ...
     <!--    店铺分类：<select id='shopCatId1' autocomplete="off" onchange='javascript:getShopCatListForGoods(this.value,"<?php echo ($object['shopCatId2']); ?>")'>
        ...
        <input placeholder='<?php echo (L("goods_name")); ?>' type="text" name="goodsName" value="<?php echo ($goodsName); ?>" />
		...
		<div class="pull-right">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu right" role="menu">
                        <li><a type="button" class="btn" href="<?php echo U('toEdit');?>" id="addgoods" data-toggle="dialog" data-width="1000" data-height="1000" data-id="dialog-mask" data-mask="true"><?php echo (L("new_add")); ?></a></li>
                        <li><a type="button" class="btn" href="<?php echo U('Goods/changeRecomStatusN');?>" data-toggle="doajaxchecked" data-group="chk" data-idname="ids" data-confirm-msg='<?php echo (L("recom_cancel_confirm")); ?>'><?php echo (L("batch_cancel_recom")); ?></a></li>
                        <li><a type="button" class="btn" href="<?php echo U('Goods/changeRecomStatus');?>" data-toggle="doajaxchecked" data-group="chk" data-idname="ids" data-confirm-msg='<?php echo (L("recom_confirm")); ?>'><?php echo (L("batch_recom")); ?></a></li>
                        <li><a type="button" class="btn" href="<?php echo U('Goods/batchDel');?>" data-toggle="doajaxchecked" data-group="chk" data-idname="ids" data-confirm-msg='<?php echo (L("delete_confirm")); ?>'><?php echo (L("batch_delete")); ?></a></li>
                        <li><a type="button" class="btn" href="<?php echo U('Goods/changeBestStatus');?>" data-toggle="doajaxchecked" data-group="chk" data-idname="ids" data-confirm-msg='<?php echo (L("boutique_confirm")); ?>'><?php echo (L("batch_boutique")); ?></a></li>
                        <li><a type="button" class="btn" href="<?php echo U('Goods/changeBestStatusN');?>" data-toggle="doajaxchecked" data-group="chk" data-idname="ids" data-confirm-msg='<?php echo (L("boutique_cancel_confirm")); ?>'><?php echo (L("batch_cancel_boutique")); ?></a></li>
                        <li><a type="button" class="btn" href="<?php echo U('Goods/unSale');?>" data-toggle="doajaxchecked" data-group="chk" data-idname="ids" data-confirm-msg='<?php echo (L("unsale_confirm")); ?>'><?php echo (L("batch_un_sale")); ?></a></li>
                    </ul>
                </div>
        </div>
	</form>	    
        ...
        <table class="table table-hover table-striped table-bordered wst-list">
           <thead>
             <tr>
               ...
               <th width='180'><?php echo (L("goods_id")); ?></th>
               <th width='180'><?php echo (L("goods_name")); ?></th>
               <!-- <th width='60'><?php echo (L("goods_sn")); ?></th>
               <th width='40'><?php echo (L("price")); ?></th> -->
               <th width='100'><?php echo (L("goods_cat")); ?></th>
               <!-- <th width='80'>店铺</th> -->
               <th width='25'><?php echo (L("recom")); ?></th>
               <th width='25'><?php echo (L("boutique")); ?></th>
               <th width='25'><?php echo (L("is_sale")); ?></th>
               <th width='25'><?php echo (L("sales")); ?></th>
           ...
           <tbody>
            <?php if(is_array($Page['info'])): $i = 0; $__LIST__ = $Page['info'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr >
               ...
               <td>
               <?php if($vo['isRecomm']==1 ): echo (L("recom")); endif; ?>
               </td>
               <td>
               <?php if($vo['isBest']==1 ): echo (L("boutique")); endif; ?>
               </td>
               <td>
               <?php if($vo['isSale']==1 ): echo (L("is_sale")); endif; ?>
               </td>
               <td><?php echo ($vo['saleCount']); ?></td>
               <td>
               <a class="btn btn-default glyphicon glyphicon-pencil" href='<?php echo U("toEdit",array("id"=>$vo["goodsId"]));?>' data-toggle="dialog" data-width="1000" data-height="600" data-id="dialog-mask" data-mask="true"><?php echo (L("edit")); ?></a> 
               <a href="<?php echo U('Goods/del?id=' . $vo[goodsId]);?>" class="btn btn-red glyphicon glyphicon-trash" data-toggle="doajax" data-confirm-msg='<?php echo (L("delete_confirm")); ?>'><?php echo (L("delete")); ?></a>
