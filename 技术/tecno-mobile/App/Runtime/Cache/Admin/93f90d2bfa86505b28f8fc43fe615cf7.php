	...
	<iframe name="upload" style="display:none"></iframe>
       ...
       <form action="<?php echo U('edit');?>" id="myform" class="pageForm" data-toggle="validate" data-reload-navtab="true" name="myform" role="form">
        ...
        <table class="table table-hover table-striped table-bordered wst-form">
           ...
           <tr>
             <th align='right'><?php echo (L("ad_position")); ?><font color='red'>*</font>：</th>
             <td>
             <select id='adPositionId' name="adPositionId">
                <option value=''><?php echo (L("select")); ?></option>
                <option value='-1' <?php if($object['adPositionId'] == -1 ): ?>selected<?php endif; ?>><?php echo (L("home_ad")); ?></option>
                <option value='0' <?php if($object['adPositionId'] == 0 ): ?>selected<?php endif; ?>><?php echo (L("product_ad")); ?></option>
                <option value='1' <?php if($object['adPositionId'] == 1 ): ?>selected<?php endif; ?>><?php echo (L("about_ad")); ?></option>
                <option value='2' <?php if($object['adPositionId'] == 1 ): ?>selected<?php endif; ?>><?php echo (L("support_ad")); ?></option>
                <option value='3' <?php if($object['adPositionId'] == 1 ): ?>selected<?php endif; ?>><?php echo (L("service_ad")); ?></option>
           ...
           <tr>
	             <th width='120'><?php echo (L("ad_info")); ?>：</th>
	             <td colspan='3'>
           ...
           <tr>
             <th align='right'><?php echo (L("ad_url")); ?>：</th>
             <td>
             ...
             <td rowspan='4' valign='top'>
	               <div style="display: inline-block; vertical-align: middle;">
							<div id="j_custom_pic_up" data-toggle="upload"
								...
								data-icon="cloud-upload"><?php echo (L("tele_pic")); ?>：</div>
           ...
           <tr>
             <th align='right'><?php echo (L("ad_video_url")); ?>：</th>
             <td>
             <input type='text' id='adVideo' name="adVideo" class="form-control wst-ipt" value='<?php echo ($object["adVideo"]); ?>'/>
             </td>
           </tr>
           <tr>
             <th align='right'><?php echo (L("ad_time")); ?><font color='red'>*</font>：</th>
             <td>
           ...
           <tr>
             <th align='right'><?php echo (L("ad_sort")); ?>：</th>
             <td>
           ...
           <tr>
             <th align='right'><?php echo (L("ad_lang")); ?><font color='red'>*</font>：</th>
             <td>
