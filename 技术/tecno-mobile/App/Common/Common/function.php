...
function getUid(){
    return $_SESSION['myInfo']['uid'];
}

function getUsername(){
    return $_SESSION['myInfo']['username'];
}

function getName(){
    return $_SESSION['myInfo']['name'];
}
...
function getChannelNameByCid($cid){
    return $channelName=M("Channel")->getFieldByCid($cid,"name");
}
