...
$frameFiles[] = '_controller/AdminZeroController.php';
$frameFiles[] = '_controller/FbController.php';
$frameFiles[] = '_controller/FbZeroController.php';
$frameFiles[] = '_controller/InstallController.php';
$frameFiles[] = '_controller/MainController.php';
$frameFiles[] = '_controller/MwUserController.php';
$frameFiles[] = '_controller/MwZeroController.php';
$frameFiles[] = '_controller/UserController.php';
$frameFiles[] = '_controller/ZeroController.php';
$frameFiles[] = '_model/Admin.php';
$frameFiles[] = '_model/Config.php';
$frameFiles[] = '_model/Fb.php';
$frameFiles[] = '_model/FbUser.php';
$frameFiles[] = '_model/FbZero.php';
$frameFiles[] = '_model/Install.php';
$frameFiles[] = '_model/MwUser.php';
$frameFiles[] = '_model/MwZero.php';
$frameFiles[] = '_model/System.php';
$frameFiles[] = '_model/User.php';
$frameFiles[] = '_model/Zero.php';
