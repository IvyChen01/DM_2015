...
<div class="header">
    <div class="page-title">
        <div class="rank-sort"><a href="?m=mwzero&a=rank" target="_self">Rank</a></div>
        <div class="new-add current">Latest</div>
    </div>
</div>
<div class="list-box">
	<div class="wrapper">
		<section id="rankList" class="clearfix">
			...
			<div class="item">
				...
				<div class="photo-rks"><a href="?m=mwzero&a=viewPic&picId=<?php echo $_value['pic_id']; ?>&pageFlag=2" target="_self"><img src="<?php echo $_value['small_pic']; ?>"/></a></div>
				<div class="tal-rks">
					<div class="tal-top">
