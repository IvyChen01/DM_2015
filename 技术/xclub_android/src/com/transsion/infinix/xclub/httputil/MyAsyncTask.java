...
//    protected abstract Result doInBackgroundJSon(Params... params);
     ...
     * {@link #doInBackground(Object[])} has animFinished.</p>
     *
     ...
     * {@link #doInBackground(Object[])} to animFinish the task as early as
     * possible.</p>
     *
     ...
     *         {@link AsyncTask.Status#RUNNING} or {@link AsyncTask.Status#animFinishED}.
     */
    ...
    private void animFinish(Result result) {
        if (isCancelled()) {
            onCancelled(result);
        } else {
            onPostExecute(result);
        }
        mStatus = Status.animFinishED;
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case MESSAGE_POST_RESULT:
                    ...
                    result.mTask.animFinish(result.mData[0]);
                    break;
