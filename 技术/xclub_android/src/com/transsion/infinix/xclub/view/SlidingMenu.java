...
public class SlidingMenu extends RelativeLayout {
	...
	public static boolean hasClickRight = false;
	...
	public void setRightView(View view) {
		LayoutParams behindParams = new LayoutParams(screenWidth/2+180,
				LayoutParams.FILL_PARENT);
	...
	public static boolean canSlideRight = false;
...
//		canSlideLeft = left;
    ...
    public void setIsCanSliding(){
    	if(canSlideRight==true){
			...
			if (mIsBeingDragged) {
				...
				if (oldScrollX >= 0 && canSlideRight) {
					...
					if (xVelocity < -VELOCITY) {
						...
						PreferenceUtils.setPrefBoolean(mContext, "isOpenSlidingMenu", true);
					} else if (xVelocity > VELOCITY) {
						PreferenceUtils.setPrefBoolean(mContext, "isOpenSlidingMenu", false);
						dx = -oldScrollX;
						if (hasClickRight) {
							hasClickRight = false;
							setCanSliding(tCanSlideLeft, tCanSlideRight);
