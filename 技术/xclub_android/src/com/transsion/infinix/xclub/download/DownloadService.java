package com.transsion.infinix.xclub.download;
...
import com.transsion.infinix.xclub.util.DialogUtil;
...
public class DownloadService extends Service {
	...
	public void onStart(Intent intent, int startId) {
	    ...
	    //发出通知
	    updateNotificationManager.notify(Constant.NOTIFICATION_DOWNLOADING, updateNotification);
	    //计时器统计流量
	    if(task!=null){
	    	task.cancel();
	    }
