...
<div class="backTop">
  <a href="javascript:;"><img src="/Public/Img/back.jpg" class="img-responsive" alt="" /></a>
    ...
    <!--附加分类导航-->
    <section class="nav-add hidden-xs hidden-sm">
      <nav class="navbar navbar-inverse">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <ul class="nav" id="navd">
              <?php if(is_array($goodsCatDetail)): $i = 0; $__LIST__ = $goodsCatDetail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cvo): $mod = ($i % 2 );++$i;?><li><a id="gcnav<?php echo ($i); ?>" href="<?php echo U('Home/Product/goodsCatDetail',array('cid'=>$cvo['catId']));?>" <?php if($cvo['catId']==$id): ?>class="add-active"<?php endif; ?>><?php echo ($cvo["catName"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
              <!-- <li><a href="#" class="add-active">16inch</a></li> -->
            </ul>
          </div>
        </div>
      </div>
...
<li data-target="#myCarousel" data-slide-to="3"></li>
   ...
   <div class="carousel-inner">
      <?php if(is_array($adsList)): $i = 0; $__LIST__ = $adsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$avo): $mod = ($i % 2 );++$i;?><div class="item" id="adpic<?php echo ($i); ?>">
          <img src="<?php echo ($avo["adFile"]); ?>" class="hidden-sm hidden-xs" alt="First slide">
<img src="<?php echo ($avo["adPhoneImg"]); ?>" class="hidden-lg hidden-md" alt="First slide">
      </div><?php endforeach; endif; else: echo "" ;endif; ?>
      <!-- <div class="item">
          <img src="/Public/Img/f16-2.png" alt="First slide">
      </div>
 -->
   </div>
   <!--Carousel nav-->
...
<!--附加2-->
<section class="nav-add hidden-md hidden-lg">
  <nav class="navbar navbar-inverse">
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        <ul class="nav" id="navd1">
          <?php if(is_array($goodsCatDetail)): $i = 0; $__LIST__ = $goodsCatDetail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cvo): $mod = ($i % 2 );++$i;?><li><a id="gcnav<?php echo ($i); ?>" href="<?php echo U('Home/Product/goodsCatDetail',array('cid'=>$cvo['catId']));?>" <?php if($cvo['catId']==$id): ?>class="add-active"<?php endif; ?>><?php echo ($cvo["catName"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
      </div>
    </div>
...
<!--title-->
<!-- <section class="title hidden-md hidden-lg">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3 class="text-center title-cont" >Fans</h3>
        <h4 class="text-center title-head" style="line-height:24px;font-size:14px">Gold with stylish luxury appearance.Copper wire motor,the wind strong,durable.permawick aircraft-grade lubricants,super-efficient,super-quiet.</h4>
      </div>
    </div>
  </div>
</section> -->
...
<div class="container-fluid">
  <div class="row">
    <p class="text-center itep3">
      <?php echo ($catName); ?>
    </p>
   <?php if(is_array($goodsList)): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-3 col-xs-6">  
      <div class="row tele-row">
          <a href="<?php echo U('Home/Product/getGoodsDetail',array('goodsCatId1'=>$vo['goodsCatId1'],'goodsCatId2'=>$vo['goodsCatId2'],'goodsId'=>$vo['goodsId']));?>"><img src="<?php echo ($vo['goodsImg']); ?>" class="img-responsive center-block" alt="" /></a>
        </div>
        <div class="col-md-3 col-xs-6 text-left tele-div">
          <span class="tele-span">
            <h4 class="tele-p1"><?php echo ($vo['goodsSpec']); ?></h4>
            <!-- <h4 class="tele-p2">Size:16"</h4> -->
          </span>
        </div>
      </div><?php endforeach; endif; else: echo "" ;endif; ?>
    <!-- <div class="col-md-6 col-xs-12 col-sm-6">
      <div class="row tele-row">
        <div class="col-md-6 col-xs-6">
          <a href="#"><img src="/Public/Img/iteimg1.png" class="img-responsive center-block" alt="" /></a>
        </div>
        <div class="col-md-6 col-xs-6 text-left tele-div">
          <span class="tele-span">
            <h4 class="tele-p1">Model:FS-40A(21)</h4>
            <h4 class="tele-p2">Size:16"</h4>
          </span>
        </div>
      </div>
    ...
    <div class="col-md-6 col-xs-12 col-sm-6">
      <div class="row tele-row">
        <div class="col-md-6 col-xs-6">
          <a href="#"><img src="/Public/Img/iteimg2.png" class="img-responsive center-block" alt="" /></a>
        </div>
        <div class="col-md-6 col-xs-6 text-left tele-div">
          <span class="tele-span">
            <h4 class="tele-p1">Model:FS-40A(21)</h4>
...
<section class="support">
  <div class="container hidden-xs hidden-sm">
    <div class="row">
      <div class="col-md-2">
        <h4 class="text-left supporth4"><a href="products.html">Products</a></h4>
...
//        alert('11')
  ...
  $(function(){
	 $('#adpic1').addClass('active'); 
         $("#gcnav1").addClass('add-active');
	 <?php if($cvo['catId']==$id): ?>$("#gcnav1").removeClass('add-active');<?php endif; ?>
  });
  /*/search*/
  /*support*/
  $(function(){
...
/*/addnav*/
$(function(){
  var $liL=$("ul#navd li").length;
  var $liL1=$("ul#navd1 li").length;
  if($liL<=1){$(".nav-add").hide()}else{$(".nav-add").show()}
  if($liL<=1){$(".nav-add").hide()}else{$(".nav-add").show()}
})
$(function(){
  $('#addnav').hover(function(){
...
$('.addnav').hover(function(){},function(){$('.nav-add').show();
	if($('.addnav').is(':hidden')){
		$('.nav-add').show();}
