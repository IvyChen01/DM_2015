...
<section class="productcover">
      ...
      <?php if(is_array($adsList)): $i = 0; $__LIST__ = $adsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$avo): $mod = ($i % 2 );++$i;?><div class="item cover-cap">
          <div class="product-caption hidden-xs hidden-sm">
            <h5 class="carsl hidden"><?php echo ($avo["adName"]); ?></h5>
            <p  class="carslp hidden">
              <?php echo ($avo["adDesc"]); ?>
            </p>
            <div class="carslps hidden"><a href="<?php echo ($avo["adURL"]); ?>">Learn more <i class="carlpsi"></i></a><a href="<?php echo ($avo["adVideo"]); ?>">Watch the film <i class="carlsii"></i></a>

</div><a class="coverlink" href="<?php echo ($avo["adURL"]); ?>"></a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="row">
          <div class="col-md-6 col-xs-6 text-left prdctp">
            <small class="prdctp1">Lorem dolor</small>
            <p class="prdctp2">
          ...
          <div class="col-md-6 col-xs-6 text-center prdctimg">
            <img src="/Public/Img/productc1.png" class="img-responsive center-block" alt="" />
          </div>
        </div>
      </div>
      ...
      <div class="col-md-12 col-xs-12">
        <div class="row text-center">
          <div class="col-md-6 col-xs-6 text-center prdctimg">
            <img src="/Public/Img/productc2.png" class="img-responsive center-block" alt="" />
          </div>
          <div class="col-md-6 col-xs-6 text-left prdctp">
            <small class="prdctp1">Gravida</small>
            <p class="prdctp2">
              Cum sociis natoque
            </p>
            <p class="prdctp3">
              Integer ultrices posuere cubilia Curae, Nulla ipsum dolor lacus, suscipit adipiscing. Cum sociis natoque penatibus et ultrices volutpat. Nullam wisi ultricies.
            </p>
          </div>
        </div>
      </div>
...
<section class="title">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h4 class="text-center title-head prdtlp1">Syinix Products</h4>
        <h3 class="text-center title-cont prdtlp2">For A Better Life</h3>
      </div>
    </div>
  </div>
</section>
...
<div class="container">
  <div class="row text-center">
    <?php if(is_array($goodsCatslist)): $i = 0; $__LIST__ = $goodsCatslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-6 col-sm-6 col-xs-6">
      <div class="col-setprd">
      <a href="<?php echo U('Home/Product/goodsCatDetail',array('cid'=>$vo['catId']));?>"><img src="<?php echo ($vo['goodsCatImg']); ?>" class="img-responsive center-block" alt="" /></a>
      <p class="prdsp1">
        <!-- Arturo Wolpert --><a href="<?php echo U('Home/Product/goodsCatDetail',array('cid'=>$vo['catId']));?>"><?php echo ($vo['catName']); ?></a>
      </p>
      <!-- <small class="prdsp2">@hello_art</small> -->
      <p class="prdsp3 hidden-xs hidden-sm">
        <!-- “Cum sociis natoque penatibus et ultrices volutpat. Nullam wisi ultricies a, gravida vitae, dapibus risus ante sodales lectus blandit eu, tempor diam pede.” -->
        <?php echo ($vo['goodsCatDesc']); ?>
      </p>  </div>
    </div><?php endforeach; endif; else: echo "" ;endif; ?>
    <!-- <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="col-setprd">
      <img src="/Public/Img/prdsimg1.png" class="img-responsive center-block" alt="" />
      <p class="prdsp1">
        Arturo Wolpert
      </p>
      <small class="prdsp2">@hello_art</small>
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="col-setprd">
      <img src="/Public/Img/prdsimg2.png" class="img-responsive center-block" alt="" />
      <p class="prdsp1">
        Chet Darrow
      </p>
      <small class="prdsp2">@cheetChet</small>
      <p class="prdsp3 hidden-xs hidden-sm">
        “Ultricies eu, faucibus quis, porttitor eros cursus lectus, pellentesque eget, bibendum a, gravida ullamcorper quam. Nullam viverra consectetuer.”
      </p>  </div>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="col-setprd">
      <img src="/Public/Img/prdsimg3.png" class="img-responsive center-block" alt="" />
      <p class="prdsp1">
        Arturo Wolpert
      </p>
      <small class="prdsp2">@hello_art</small>
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="col-setprd">
      <img src="/Public/Img/prdsimg4.png" class="img-responsive center-block" alt="" />
      <p class="prdsp1">
        Eryn Benny
      </p>
      <small class="prdsp2">@Eryn_Benny</small>
      <p class="prdsp3 hidden-xs hidden-sm">
        “vel bibendum sapien massa ac turpis faucibus orci luctus non, consectetuer lobortis quis, varius in, purus. Integer ultrices posuere cubilia Curae.”
      </p>  </div>
    </div>
    <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="col-setprd">
      <img src="/Public/Img/prdsimg5.png" class="img-responsive center-block" alt="" />
      <p class="prdsp1">
        Arturo Wolpert
      </p>
      <small class="prdsp2">@hello_art</small>
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
      <div class="col-setprd">
      <img src="/Public/Img/prdsimg6.png" class="img-responsive center-block" alt="" />
      <p class="prdsp1">
        Eryn Benny
      </p>
      <small class="prdsp2">@Eryn_Benny</small>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 hidden">
        <h4 class="text-center title-head prdtlp3">rhoncus eu luctus et interdum.</h4>
        <h3 class="text-center title-cont prdtlp4">Lorem ipsum dolor sit amet enim. Etiam ullamcorper. Suspendisse a
...
//        alert('11')
  ...
  /*prdlink*/
  $(function(){
    $('a.prd-linka').click(function(){
      var t = $(window).scrollTop();
      $('body,html').animate({'scrollTop':t+500},200)
    })
  })
  /*/prdlink*/
     /*form*/
