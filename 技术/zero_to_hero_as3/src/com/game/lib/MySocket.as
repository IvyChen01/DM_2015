package com.game.lib
{
	...
	/**
	 * 连接Socket事件
	 * @eventType	com.game.lib.events.SocketEvent.CONNECT
	 */
	[Event(name = "SocketEvent_CONNECT", type = "com.game.lib.events.SocketEvent")]
	
	/**
	 * 接收Socket数据事件
	 * @eventType	com.game.lib.events.SocketEvent.SOCKET_DATA
	 */
	[Event(name = "SocketEvent_SOCKET_DATA", type = "com.game.lib.events.SocketEvent")]
	
	/**
	 * 关闭Socket事件
	 * @eventType	com.game.lib.events.SocketEvent.CLOSE
	 */
	[Event(name = "SocketEvent_CLOSE", type = "com.game.lib.events.SocketEvent")]
	
	/**
	 * Socket出错事件
	 * @eventType	com.game.lib.events.SocketEvent.ERROR
	 */
	[Event(name = "SocketEvent_ERROR", type = "com.game.lib.events.SocketEvent")]
