package com.game.lib
{
	...
	public class SimpleTip
	{
		 ...
		 */
		public function SimpleTip(aContent:MovieClip, aStage:Stage, aStageWidth:Number, aStageHeight:Number, aMaxLabelWidth:Number = 300, aHMargin:Number = 5, aVMargin:Number = 5, aOffsetX:Number = 20, aOffsetY:Number = 10):void
		{
			_content = aContent;
