        ...
        <div class="modal-content">
            ...
            <?php $buy_links = get_post_meta( $post->ID, '_buy', true );?>
                ...
                <div class="country-list" id="area-0">
                    <div class="row">
                        <div class="col-xs-4 col-sm-2 buy-flag"><img src="<?php echo theme_image_url() ?>/flag-cotedivorie.jpg"><span>Cote d'Ivorie</span></div>
                ...
                <div class="country-list" id="area-2" style="display: none;">
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-sm-2 buy-flag"><img src="<?php echo theme_image_url() ?>/flag-philippines.jpg"><span>Philippines</span></div>
                        <div class="col-xs-8 col-sm-10 buy-vendor">
                            <div class="row">
                                <?php
                                $i=0;
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-sm-2 buy-flag"><img src="<?php echo theme_image_url() ?>/flag-vietnam.jpg"><span>Vietnam</span></div>
                        <div class="col-xs-8 col-sm-10 buy-vendor">
                            <div class="row">
                                <?php
                                $i=0;
