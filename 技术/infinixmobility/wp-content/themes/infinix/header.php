                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/smartphone/hot-2-for-pk-only/">HOT 2 PK</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/smartphone/hot/">HOT</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">ACCESSORY</a>
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/hot-2-screen-film/">HOT 2 Screen Protector</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/zero-case/">ZERO Accessory</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/hot-note-case/">HOT NOTE Accessory</a></li>
                        </ul>
                    </li>
