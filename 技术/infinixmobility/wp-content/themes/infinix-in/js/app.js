(function( $ ) {
    ...
    $('.support-selection').on('click', '#service a', function(){
        ...
        $('#phone').collapse('hide').siblings('.selection-head').html('Select your phone').prop("disabled", true);
        $('#location').collapse('hide').siblings('.selection-head').html('Select your location').prop("disabled", true);
