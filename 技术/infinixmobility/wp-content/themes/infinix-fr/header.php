                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/smartphone/zero-2/">ZERO 2</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/smartphone/zero-2-lte/">ZERO 2 LTE</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/smartphone/zero/">ZERO</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">NOTE</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/smartphone/note-2/">NOTE 2</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/smartphone/hot/">HOT</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">ACCESSOIRES</a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/hot-2-big-battery/">HOT 2 Batterie grande capacité</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/hot-2-flip-cover/">HOT 2 Smart cover</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/hot-2-screen-film/">HOT 2 Film de protection</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/zero-case/">ZERO ACCESSOIRES</a></li>
                            <li><a role="menuitem" tabindex="-1" href="<?php echo site_url(); ?>/acc/hot-note-case/">HOT NOTE ACCESSOIRES</a></li>
                        </ul>
                    </li>
