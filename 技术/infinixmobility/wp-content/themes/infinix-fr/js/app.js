(function( $ ) {
    ...
    $('.support-selection').on('click', '#service a', function(){
        ...
        $('#phone').collapse('hide').siblings('.selection-head').html('Sélectionnez votre téléphone').prop("disabled", true);
        $('#location').collapse('hide').siblings('.selection-head').html('Sélectionnez votre emplacement').prop("disabled", true);
