            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 pull-right">
                    <ul class="nav navbar-nav navbar-right nav-language">
                        <li class="dropup">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">LANGUES</a>
                ...
                <div class="col-xs-12 col-sm-6">
                    <ul class="help-links">
                        <li><a href="mailto:<?php echo get_option("support_email")?>">Contactez nous</a></li>
                    </ul>
                </div>
            </div>
            <hr class="help-hr">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <form action="//infinixmobility.us9.list-manage.com/subscribe/post?u=dcf170f04f3951b2480d4a6bc&amp;id=ad9e9e8df2" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="form-inline" target="_blank" novalidate="">
                        ...
                        <input type="submit" value="Abonnez-vous" name="subscribe" id="mc-embedded-subscribe">
                    </form>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <ul class="sns-list">
