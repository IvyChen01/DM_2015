...
class AdminController
{
	...
	private function db()
	{
		...
		foreach ($allTables as $tbName)
		{
			...
			$tableInfo['records'] = $this->install->getRecords($tbName, 0, 1);
...
class AdminHongBaoController
{
	...
	private function luckyCount()
	{
		...
		include(Config::$viewDir . 'hong_bao/admin_count.php');
	}
	...
	private function winlist()
	{
		...
		include(Config::$viewDir . 'hong_bao/admin_winlist.php');
	}
...
class AdminNewsController
{
	...
	private function main()
	{
		...
		include(Config::$viewDir . 'news/admin_main.php');
	}
	...
	{
		$this->checkLogin();
		include(Config::$viewDir . 'news/admin_add.php');
	}
	...
	private function modify()
	{
		...
		{
			include(Config::$viewDir . 'news/admin_modify.php');
		}
	}
	...
	private function detail()
	{
		...
		{
			include(Config::$viewDir . 'news/admin_detail.php');
		}
	}
...
class AdminZhuanPanController
{
	...
	private function luckyCount()
	{
		...
		include(Config::$viewDir . 'admin/lucky_count.php');
	}
	...
	private function winlist()
	{
		...
		include(Config::$viewDir . 'admin/winlist.php');
	}
...
class ChatController
{
	...
	private function main()
	{
		include(Config::$viewDir . 'chat/main.php');
	}
}
				...
				case 'text':
					switch ($content)
					{
						case '我要抽奖':
							...
							$contentStr = '猛戳这里进入抽奖：' . "\n" . '<a href="www.test.com/?m=zhuanPan&a=lucky&openId=' . $fromUserName . '&key=' . $key . '">年会抽奖第一弹</a>';
							//$contentStr = '转盘抽奖结束了哦~';
							$msgType = "text";
						...
						case '我要抢红包':
							...
							$contentStr = '猛戳这里抢红包：' . "\n" . '<a href="http://www.test.com/?m=hongBao&a=lucky&openId=' . $fromUserName . '&key=' . $key . '">传音年会抢红包</a>';
