...
<div class="page12">
	...
	<p class="kouHao">Play Game, Win prizes from TECNO!!!</p>
...
you invite, the more coins you will get.</p>
	...
	<p class="timeTxt"><img src="./images/dot.png" />Nov.25 - Dec.8</p>
	<p class="prize">Prize</p>
	<p class="tecnoPhantom"><img src="./images/dot.png" />The first Prize (3 persons): 32GB TF card + T-shirt</p>
	<p class="powerBank"><img src="./images/dot.png" />The second Prize (3 persons): 16GB TF card + T-shirt</p>
	<p class="selfieStick"><img src="./images/dot.png" />The third Prize (4 persons): 8GB TF card + T-shirt</p>
</div>
<script>
