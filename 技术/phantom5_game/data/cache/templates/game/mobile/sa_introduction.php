...
<link href="css/sa_mobile_index.css?v=2016.1.21_19.07" rel="stylesheet" type="text/css" />
</head>
...
<div class="page2">
	<a href="./?m=game&a=main" target="_self">
		...
		<p class="t5">22th Jan to 02nd Feb</p>
		<p class="t6">Prize</p>
		<p class="t7">1 Phantom 5</p>
		<p class="t8">3 Selfie Sticks</p>
		<p class="t9">2 Flash Disks</p>
		<p class="t10">2 Mobile Discount</p>
