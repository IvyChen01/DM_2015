...
<div class="page11">
	...
	<img src="./images/ke/mobile/page9/title.png" class="title" />
	...
	<div class="list">
		<ul>
			...
			<li>
				...
				<?php } ?>
				<?php if ($value['rank'] <= 3) { ?>
				<img src="./images/ke/mobile/page9/<?php echo $value['rank']; ?>.png" class="guang" />
				<?php } else { ?>
				...
				<img src="./images/ke/mobile/page9/gem.png" class="gem" />
