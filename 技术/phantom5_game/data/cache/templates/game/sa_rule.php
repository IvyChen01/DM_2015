...
<link href="css/sa_index.css" rel="stylesheet" type="text/css" />
...
you invite, the more coins you will get.</p>
	...
	<p class="timeTxt"><img src="./images/dot.png" />22th Jan to 02nd Feb</p>
	<p class="prize">Prize</p>
	<p class="tecnoPhantom"><img src="./images/dot.png" />1 Phantom 5</p>
	<p class="powerBank"><img src="./images/dot.png" />3 Selfie Sticks</p>
	<p class="selfieStick"><img src="./images/dot.png" />2 Flash Disks</p>
	<p class="discount"><img src="./images/dot.png" />2 Mobile Discount</p>
</div>
<script>
