...
you invite, the more coins you will get.</p>
	...
	<p class="t5"><img src="./images/dot.png" />Nov.25 - Dec.8</p>
	<p class="t6">Prize</p>
	<p class="t7"><img src="./images/dot.png" />The first Prize (3 persons): 32GB TF card + T-shirt</p>
	<p class="t8"><img src="./images/dot.png" />The second Prize (3 persons): 16GB TF card + T-shirt</p>
	<p class="t9"><img src="./images/dot.png" />The third Prize (4 persons): 8GB TF card + T-shirt</p>
