...
<div class="news-add">
	...
	<ul>
		<li>
			...
			<input class="com-val img-url img-val"  type="text" name="photoTxt" id="photoTxt" value="" />
		</li>
		<li>
			<span>Name：</span><input type="text" name="nameTxt" id="nameTxt" />
		</li>
		<p>Introduction：</p>
		<li>
		...
		<li>
			<span>Publish Time：</span><input type="text" name="pubTime" id="pubTime" value="<?php echo $_pubTime; ?>" />
		</li>
		<li>
			<input type="button" name="publish" id="publish" value="Add"/>
		</li>
	</ul>
</div>
...
function onClickAdd(e)
{
	...
	$.post("?m=adminFans&a=doAdd", {photo: photoTxt, username: nameTxt, content: content, pubtime: pubTime}, onAdd);
}
